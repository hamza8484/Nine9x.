    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/Search_purchases" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">إختيار نوعية الفواتير</p><select class="form-control select2" name="type"
                                required>
                                <option value="{{ $type ?? 'إختر نوع الفاتورة' }}" selected>
                                    {{ $type ?? 'إختر نوع الفاتورة' }}
									</option>
									<option value="">الكـل</option>
									<option value="نقــدي">نقــدي</option>
									<option value="شــبكة">شــبكة</option>
									<option value="آجــل">آجــل</option>
                            </select>
                        </div><!-- col-4 -->


                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="pur_number">
                            <p class="mg-b-10">البحث برقم الفاتورة</p>
                            <input type="text" class="form-control" id="pur_number" name="pur_number">
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap" style=" text-align: center">
                            <thead>
                                <tr>
									...
									<th class="wd-15p border-bottom-0 text-center">رقم الفاتورة</th>
									<th class="wd-15p border-bottom-0 text-center">تاريخ الفاتورة</th>
									<th class="wd-20p border-bottom-0 text-center">المورد</th>
                            ...
                            @foreach ($details as $purchase)
                                <tr>
									...
									<td class="text-center"><a href="{{ route('purchases.show', $purchase->id) }}">{{ $purchase->pur_number }}</a></td> 
											...
											<td class="text-center">{{ $purchase->inv_payment }}</td>
											<td class="text-center">{{ number_format ($purchase->vat_value,2) }}</td>
											<td class="text-center">{{ $purchase->discount_value }}%</td>
											<td class="text-center">{{ number_format ($purchase->total_deu,2) }} </td>
                                    <td >     
