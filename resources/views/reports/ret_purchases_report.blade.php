...
@section('title')
    تقرير مرتجع المشتريـات - ناينوكس
@stop
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/Search_ret_purchases" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="ret_pur_number">
                            <p class="mg-b-10">البحث برقم المرتجع</p>
                            <input type="text" class="form-control" id="ret_pur_number" name="ret_pur_number">
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap" style=" text-align: center">
                            <thead>
                                <tr>
									...
									<th class="wd-20p border-bottom-0 text-center">رقم الفاتورة</th>
                            ...
                            <tbody>
                            @foreach ($details as $retPurchase)
                                <tr>
										...
										<td class="text-center">{{ $retPurchase->ret_pur_payment }}%</td>
										<td class="text-center">{{ $retPurchase->vat_value }}%</td>
										<td class="text-center">{{ $retPurchase->discount_value }}%</td>
										<td class="text-center">{{ $retPurchase->total_deu }} </td>
                                    <td >     
