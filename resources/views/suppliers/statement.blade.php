...
@section('content')
    <div class="container" dir="rtl">
        <div class="card">
            <h1>كشف حساب للمورد: {{ $supplier->sup_name }}</h1>

            <div class="balance-info">
                <h2>الرصيد الحالي: <strong>{{ $supplier->sup_balance }} </strong> - ريال سعودي</h2>
            </div>
            ...
            <div class="d-flex justify-content-between mb-4">
                ...
                <!-- زر الرجوع إلى صفحة المورد -->
                <a href="{{ route('suppliers.index') }}" class="btn btn-back">رجوع إلى قائمة الموردين</a>
            </div>
