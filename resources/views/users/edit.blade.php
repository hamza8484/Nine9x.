    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mg-b-20">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>{{ __('home.User Type') }}</strong>
                ...
                <div class="mg-t-30">
                    <a class="btn btn-primary btn-sm" style="font-size: 19px; width: 300px; height: 40px;" href="{{ route('users.index') }}">{{ __('home.BackToUsersList') }}</a>
                    <button class="btn btn-main-primary pd-x-20" style="font-size: 19px; width: 300px; height: 40px;">{{ __('home.Update User') }}</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
