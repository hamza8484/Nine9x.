...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('home.account_types') }}</h4><span class="text-muted mt-1 tx-19 mr-2 mb-0">/ {{ __('home.edit_account_type') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form action="{{ route('account_types.update', $type->id) }}" method="POST">
                ...
                <div class="form-group">
                    <label for="is_active">
                        <input type="checkbox" name="is_active" id="is_active" {{ old('is_active', $type->is_active) ? 'checked' : '' }}> {{ __('home.active_account') }}
                    </label>
                </div>
